package come.example.ProductionReadyFeatures.Filters;

import come.example.ProductionReadyFeatures.entities.User;
import come.example.ProductionReadyFeatures.services.JwtService;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
           ...
           try {
               ...
               // Invalid token or unable to authenticate; continue without security context
           }
